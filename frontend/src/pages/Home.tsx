...
function Home() {
    ...
    const dashboard = async () => {
      console.log('fetching patient data initiated');
      
        console.log('fetching patient data executing');
      try{
    ...
    useEffect(() => {
      ...
      dashboard(); // Fetch data when component mounts if user is logged in only
      }
