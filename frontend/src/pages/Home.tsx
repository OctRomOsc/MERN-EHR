...
function Home() {
    ...
    const dashboard = async () => {
      try{
          ...
          const response : Response = await fetch(`${apiUrl}${port}/api/dashboard` , {
            method: "POST",
            headers: {
    ...
    const update = async () => {
      try{
        const response : any = await fetch(`${apiUrl}${port}/api/update` , {
          method: "PATCH",
          headers: {
            'Content-Type': 'application/json'
          },
    ...
    const logout = async () => {
      try{
          ...
          const response : Response = await fetch(`${apiUrl}${port}/api/logout` , {
            method: "POST",
            headers: {
              'Content-Type': 'application/json'
            },
